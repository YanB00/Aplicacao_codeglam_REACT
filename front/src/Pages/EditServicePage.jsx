...
export default function EditServicePage({ userId: propUserId }) {
  ...
  useEffect(() => {
        console.log("EditServicePage: Received propUserId:", propUserId);
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      setSaving(false);
          navigate(`/servico/${serviceIdFromParams}${propUserId ? `?userId=${propUserId}` : ''}`);
        } catch (err) {
  ...
  if (loading) return <div className={styles.loading}>Carregando dados do serviço para edição...</div>;
    ...
    if (error && !loading) return (
        <div className={styles.editServicePageContent}>
        ...
        <div className={styles.editServicePageContent}>
            ...
            <div className={styles.content}>
                <form className={styles.form} onSubmit={handleSave}>
                    ...
                    <div className={styles.formRowDuracao}>
                        <label htmlFor="duracaoHoras" className={styles.labelDuracao}>Duração:</label>
                        <div className={styles.inputsWrapperDuracao}>
                            <input
                                id="duracaoHoras"
                                type="number"
                                value={duracaoHoras}
                                ...
                                placeholder="HH"
                                min="0"
                                className={styles.duracaoInputField}
                                required
                            />
