    ...
    const fetchDropdownData = async () => {
      ...
      if (salaoId) {
        try {
          ...
          if (servicesRes.ok) {
            ...
            console.error("Falha ao buscar serviços para o header");
            setServicesList([]);
          }
        } catch (error) {
          console.error("Erro ao buscar serviços para o header:", error);
          setServicesList([]);
        }
      } else {
        setServicesList([]);
      ...
      try {
        ...
        if (employeesRes.ok) {
          ...
          console.error("Falha ao buscar funcionários para o header");
          setEmployeesList([]);
        }
      } catch (error) {
        console.error("Erro ao buscar funcionários para o header:", error);
        setEmployeesList([]);
      }
